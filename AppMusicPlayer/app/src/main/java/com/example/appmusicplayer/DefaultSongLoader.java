...
public class DefaultSongLoader {
    ...
    private PhnSongs song;
    private ArrayList<PhnSongs> songList = new ArrayList<>();
    private Uri uri;
    ...
    public PhnSongs getSong() {
        return song;
    }

    public void setSong(PhnSongs song) {
        this.song = song;
    }
    ...
    public ArrayList<PhnSongs> getSongList() {
        return songList;
    }

    public void setSongList(ArrayList<PhnSongs> songList) {
